...
<body>
	...
	<section>
		...
		<div id="bricks" style="background-image: url('../resources/images/cinema/bricks.jpg');">
			<div id="cinemaName"
				style="background-image: url('../resources/images/cinema/cmain.jpg'); background-size: contain;">
				...
				<div id="cinematable">
					<div class="cmtitle">
						<c:forEach items="${locList}" var="loc">
							...
							<c:if
								test="${loc.cinema_loc eq '인천' || loc.cinema_loc eq '강원' || loc.cinema_loc eq '대전/충청' || loc.cinema_loc eq '대구' || loc.cinema_loc eq '부산/울산' || loc.cinema_loc eq '경상' || loc.cinema_loc eq '광주/전라/제주'}">
