...
-->
					...
					<div class="ribbon-2">
						<div class="checkboxes-container">
							<div class="control-group">
								<input type="checkbox" class="red-heart-checkbox heart"
									id="red-check${mlist.movieInfo_num}"> <label
									for='red-check${mlist.movieInfo_num} heartl'> <c:if
										test="${status.count lt 11}">
					...
					<div class="thumb"
						style="background-image: url('${mlist.movieInfo_poster}');">
					</div>
					...
					<div class="elegant-modal" role="alert">
						...
						<table style="margin: 0 auto;">
							<tr class="trm" style="width: 390px;">
								...
								<td class="tdm2" style="text-align: left; padding-top: 20px;">
									<c:choose>
										<c:when test="${mlist.movieInfo_grade eq '전체 관람가'}">
											<img style="border-radius: 10px;" alt="" src="../resources/images/movieSelect/m1.png">
										</c:when>
										<c:when test="${mlist.movieInfo_grade eq '12세 관람가'}">
											<img style="border-radius: 10px;" alt="" src="../resources/images/movieSelect/m2.png">
										</c:when>
										<c:when test="${mlist.movieInfo_grade eq '15세 관람가'}">
											<img style="border-radius: 10px;" alt="" src="../resources/images/movieSelect/m3.png">
										</c:when>
										<c:when test="${mlist.movieInfo_grade eq '청소년 관람불가'}">
											<img style="border-radius: 10px;" alt="" src="../resources/images/movieSelect/m4.png">
										</c:when>
									</c:choose>
								</td>
							</tr>
						...
						<div>
							<div class="paragraph-modal" style="float: left;">
								<table class="tmodal paragraph-modal"
									style="position: relative; left: 256px; top: 20px; text-align: left; margin-bottom: 20px;">
									<tr>
	...
	<!-- footer -->
	<footer style="color: black; text-shadow: none; font-weight: normal;">
