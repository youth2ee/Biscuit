...
<div class="mmain" style="background-color: #3b3b3b; padding-top: 10px; padding-bottom: 10px; color: black; padding-left: 10px;"><a  style="color: white;"  href="./myPage_movie_heart">내가 찜한 영화</a></div>
